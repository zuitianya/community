...
class AdminuserController extends Controller
{
     ...
     * @param integer $id
     * @return AdminuserModel the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AdminuserModel::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionPrivilege($id)
    {
    	...
    	$allPrivileges = AuthItemModel::find()->select(['name','description'])
    	...
    	$AuthAssignments=AuthAssignmentModel::find()->select(['item_name'])
    	...
    	{
    		AuthAssignmentModel::deleteAll('user_id=:id',[':id'=>$id]);
