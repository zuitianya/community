...
class TagModel extends BaseModel
{
    ...
    public static function addTags($tags)
    {
    	...
    	{
    		$aTag = TagModel::find()->where(['name'=>$name])->one();
    		$aTagCount = TagModel::find()->where(['name'=>$name])->count();
    ...
    public static function findTagWeights($limit=20)
    {
    	...
    	$models=TagModel::find()->orderBy('frequency desc')->limit($limit)->all();
    	$total=TagModel::find()->limit($limit)->count();
